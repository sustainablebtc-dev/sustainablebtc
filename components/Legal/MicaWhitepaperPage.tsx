            ...
            <div className={styles.container}>
               <div className={styles.heroContent}>
                  ...
                  <p className={styles.notification}>
                     <span>This whitepaper was notified to the Central Bank of Ireland in accordance with Regulation (EU) 2023/1114 on February 27th, 2026.</span>
                     <span>It was subsequently amended on [March 31st, 2026] to include the Digital Token Identifier (DTI) and Equivalent Digital Token Group Identifier (FFG/EDTG).</span>
